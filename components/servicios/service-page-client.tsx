...
const WebVisual = () => (
  <div className="relative w-full h-full p-4 flex items-center justify-center">
    <motion.div
      ...
      className="w-full max-w-[320px] aspect-[4/3] bg-background rounded-xl border border-white/10 shadow-2xl overflow-hidden relative animate-float"
    >
...
const SoftwareVisual = () => (
  <div className="relative w-full h-full p-4 flex items-center justify-center">
    ...
    >
      <div className="h-6 bg-white/5 border-b border-white/10 flex items-center px-3">
  ...
  <div className="relative w-full h-full p-4 flex items-center justify-center">
    <div className="w-full max-w-[260px] aspect-square bg-card rounded-full border border-white/5 p-8 relative flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mt-4 px-4 py-1.5 bg-green-500/10 rounded-full border border-green-500/20 text-[10px] text-green-400">Uptime: 99.9%</div>
      </div>
    </div>
  </div>
)
    ...
    <div className="w-full max-w-[300px] bg-card rounded-2xl border border-white/10 p-6 shadow-2xl overflow-hidden">
      ...
      <div className="flex items-end gap-1.5 h-24">
        {[40, 30, 45, 60, 55, 80, 70, 90, 100].map((h, i) => (
          <div key={i} className="flex-1 bg-primary/20 rounded-t-sm animate-bar"
            style={{ height: `${h}%`, backgroundColor: i === 8 ? 'var(--color-primary)' : '', animationDelay: `${i * 0.1}s` }}
          />
        ))}
      </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
              ...
              <a href="https://wa.me/573116710009?text=Hola%2C%20quiero%20cotizar%20un%20proyecto."
              ...
              <a href="#proceso" className="px-8 py-4 border border-white/10 text-white font-medium rounded-full hover:bg-white/5 transition-all">
                Ver metodología
              </a>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-card/30 border-y border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">¿Tu negocio se siente estancado por estas razones?</h2>
            <p className="text-white/60">Identificamos los puntos de dolor más comunes que frenan el crecimiento digital en Colombia.</p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-white/70 mb-8">{service.solution.description}</p>
              ...
              <div className="mt-12 p-8 rounded-2xl bg-primary/5 border border-primary/10">
                <p className="italic text-white/80">"Nuestro enfoque no es solo programar; es entender tu mercado y aplicar IA para que cada línea de código trabaje para tus ventas."</p>
                <p className="mt-4 font-bold text-primary">— Equipo Dinogrowth</p>
              </div>
            </div>
            <div className="relative aspect-square rounded-[3rem] overflow-hidden border border-white/10 bg-card shadow-2xl">
              ...
              <div className="absolute top-8 left-8 p-4 rounded-xl bg-background/80 backdrop-blur-md border border-white/10 z-20 shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-white">Sistema Optimizado</span>
                </div>
              </div>
      ...
      <section id="contacto" className="py-20 md:py-32 container mx-auto px-6">
        <div className="bg-gradient-to-br from-primary to-primary/80 rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden">
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-6xl font-bold text-white mb-8">¿Listo para dar el siguiente paso?</h2>
            <p className="text-xl text-white/90 mb-12">Agenda una sesión de descubrimiento y descubre cómo podemos transformar tu negocio con tecnología de clase mundial.</p>
            <a href="https://wa.me/573116710009?text=Hola%2C%20quiero%20hablar%20con%20un%20experto%20de%20dinogrowth."
              target="_blank" rel="noopener noreferrer"
